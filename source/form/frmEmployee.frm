...
Private Sub cmdNewEmployee_Click()
    Load frmEmployee_Detail
    frmEmployee_Detail.txtCreateEmp = gUSERNAME
    frmEmployee_Detail.Show vbModal
    
    Unload frmEmployee_Detail
...
'    End If
    ...
    Dim dicEmployeeList As Scripting.Dictionary
    
    Set dicEmployeeList = SearchPagedList(Me.name, dicParam, mPageSize, PageNum)
    
    Call FillGrid(Me.grdList, dicEmployeeList)
    bolcanCboSkipWork = False
    Call FillPageNavi(Me, dicEmployeeList)
...
Private Sub Form_Resize()
    ...
    'Me.cmdNewEmployee.Left = Me.width - Me.cmdNewEmployee.width - 100 - Me.cmdSearch.width
...
Private Sub grdList_DblClick()
    ...
    If Me.grdList.Row >= 1 Then
        Load frmEmployee_Detail
        Call frmEmployee_Detail.LoadDetail(Me.grdList.TextMatrix(Me.grdList.Row, 0))
        frmEmployee_Detail.Show vbModal
        Unload frmEmployee_Detail
    End If
