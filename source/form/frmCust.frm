...
Private Sub cmdNew_Click()
    Load frmCust_Detail
    frmCust_Detail.txtCreateEmp = gUSERNAME
    frmCust_Detail.Show vbModal
    
    Unload frmCust_Detail
...
Public Function doSearch(Optional ByVal PageNum As String = 1) As String
    ...
    Dim dicCustList As Scripting.Dictionary
    
    Set dicCustList = SearchPagedList(Me.name, dicParam, mPageSize, PageNum)
    
    Call FillGrid(Me.grdList, dicCustList)
    bolcanCboSkipWork = False
    Call FillPageNavi(Me, dicCustList)
...
Private Sub Form_Resize()
    ...
    'Me.cmdNewCust.Left = Me.width - Me.cmdNewCust.width - 100 - Me.cmdSearch.width
...
Private Sub grdList_DblClick()
    ...
    If Me.grdList.Row >= 1 Then
        Load frmCust_Detail
        Call frmCust_Detail.LoadDetail(Me.grdList.TextMatrix(Me.grdList.Row, 0))
        frmCust_Detail.Show vbModal
        Unload frmCust_Detail
    End If
