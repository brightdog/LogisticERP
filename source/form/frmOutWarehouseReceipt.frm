...
Begin VB.Form frmOutWarehouseReceipt 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   ClientHeight    =   6675
   ClientLeft      =   0
   ...
   EndProperty
   Icon            =   "frmOutWarehouseReceipt.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6675
   ...
   Begin VB.TextBox txtWarehouseID 
      ...
      Width           =   3300
   End
   Begin VB.Label lblOutWarehouseReceiptID 
      Caption         =   "出库单编号："
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9
   ...
   End
End
Attribute VB_Name = "frmOutWarehouseReceipt"
...
Private Sub cmdNew_Click()
    Load frmOutWarehouseReceipt_Detail
    frmOutWarehouseReceipt_Detail.txtCreateEmp = gUSERNAME
    frmOutWarehouseReceipt_Detail.Show vbModal
    
    Unload frmOutWarehouseReceipt_Detail
...
Private Sub grdList_DblClick()
    ...
    If Me.grdList.Row >= 1 Then
        Load frmOutWarehouseReceipt_Detail
        Call frmOutWarehouseReceipt_Detail.LoadDetail(Me.grdList.TextMatrix(Me.grdList.Row, 0))
        frmOutWarehouseReceipt_Detail.Show vbModal
        Unload frmOutWarehouseReceipt_Detail
    End If
