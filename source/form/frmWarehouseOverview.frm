...
Begin VB.Form frmWarehouseOverview 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   ClientHeight    =   6675
   ClientLeft      =   0
   ...
   EndProperty
   Icon            =   "frmWarehouseOverview.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6675
   ...
   Begin VB.ListBox lstIncremental 
      ...
      Width           =   1395
   End
   Begin VB.TextBox txtToWarehouseName 
      Appearance      =   0  'Flat
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   10.5
   ...
   Begin VB.CommandButton cmdSearch 
      ...
      Width           =   1155
   End
   Begin VB.TextBox txtToWarehouseID 
      Appearance      =   0  'Flat
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   10.5
   ...
   Begin VB.Label lblSenderName 
      ...
      Width           =   1275
   End
   Begin VB.Label lblWarehouseOverviewID 
      Caption         =   "仓库编号："
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9
   ...
   End
End
Attribute VB_Name = "frmWarehouseOverview"
...
Private Sub Form_Resize()
    ...
    'Me.cmdNewWarehouseOverview.Left = Me.width - Me.cmdNewWarehouseOverview.width - 100 - Me.cmdSearch.width
...
Private Sub grdList_DblClick()
    ...
    If Me.grdList.Row >= 1 Then
        ...
        Call frmOrder_Detail.LoadDetailByExpressNO(Me.grdList.TextMatrix(Me.grdList.Row, 0))
...
Private Sub txtToWarehouseID_Change()
    Call ShowIncrementalSearchList("tblWarehouse", "WarehouseID", "=", Me.txtToWarehouseID, Me.lstIncremental)
End Sub

Private Sub txtPickupReceiptID_KeyDown(KeyCode As Integer, Shift As Integer)
    Call SelectIncrementalResult(KeyCode, Me.txtToWarehouseID, lstIncremental)
End Sub




Private Sub txtToWarehouseName_Change()

    Call ShowIncrementalSearchList("tblWarehouse", "WarehouseName", "like", Me.txtToWarehouseName, Me.lstIncremental)
    
End Sub

Private Sub txtToWarehouseName_KeyDown(KeyCode As Integer, Shift As Integer)

    Call SelectIncrementalResult(KeyCode, Me.txtToWarehouseName, lstIncremental)
