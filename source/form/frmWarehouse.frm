...
Private Sub cmdNew_Click()
    Load frmWarehouse_Detail
    frmWarehouse_Detail.txtCreateEmp = gUSERNAME
    frmWarehouse_Detail.Show vbModal
    
    Unload frmWarehouse_Detail
...
Private Sub grdList_DblClick()
    If Me.grdList.Row >= 1 Then
        Load frmWarehouse_Detail
        Call frmWarehouse_Detail.LoadDetail(Me.grdList.TextMatrix(Me.grdList.Row, 0))
        frmWarehouse_Detail.Show vbModal
        Unload frmWarehouse_Detail
    End If
End Sub
