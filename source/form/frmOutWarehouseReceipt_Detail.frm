...
Begin VB.Form frmOutWarehouseReceipt_Detail 
   Caption         =   "出库单明细"
   ClientHeight    =   6675
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7380
   Icon            =   "frmOutWarehouseReceipt_Detail.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   6675
   ScaleWidth      =   7380
   ...
   Begin TDBDate6Ctl.TDBDate txtCreateDT 
      ...
      _ExtentX        =   2355
      _ExtentY        =   556
      Calendar        =   "frmOutWarehouseReceipt_Detail.frx":000C
      Caption         =   "frmOutWarehouseReceipt_Detail.frx":0107
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "宋体"
         Size            =   9
         Charset         =   134
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmOutWarehouseReceipt_Detail.frx":016A
      Keys            =   "frmOutWarehouseReceipt_Detail.frx":0188
      Spin            =   "frmOutWarehouseReceipt_Detail.frx":01E6
      AlignHorizontal =   0
      AlignVertical   =   0
      Appearance      =   1
   ...
   End
End
Attribute VB_Name = "frmOutWarehouseReceipt_Detail"
...
Public Function LoadDetail(ByVal ID As String) As String
    ...
    strPostData = "{""Type"":""LoadOutWarehouseReceipt_Detail"",""Fields"":[""OutWarehouseReceiptID""],""Values"":[""" & ID & """]}"
...
Private Sub cmdSave_Click()
    ...
    For Each ctl In Me.Controls
        ...
        '                Else
        '
        '                    If MsgBox("友情提示:暂未选择任何运单，是否继续保存当前空白出库单？", vbYesNoCancel + vbQuestion, "提示信息") = vbYes Then
        '                        'Do Nothing~
        '                    Else
        '                        Exit Sub
        '                    End If
    ...
    strPostData = "{""Type"":""OutWarehouseReceipt_Detail"",""Fields"":[" & Left(strFields, Len(strFields) - 1) & "],""Values"":[" & Left(strValues, Len(strValues) - 1) & "]}"
    strUrl = LCase(Me.name) & ".asp"
    Dim strResult As String
    Debug.Print strUrl
    Debug.Print strPostData
...
Dim objFrm As VB.Form
Set objFrm = New frmOrderOutWarehouse
    Load objFrm
    objFrm.txtOutWarehouseReceiptNo.Text = Me.txtOutWarehouseReceiptID.Text
    Call objFrm.Search(Me.txtOutWarehouseReceiptID.Text)
    DoEvents
    objFrm.Move (Screen.width - objFrm.width) / 2, (Screen.Height - objFrm.Height) / 2
