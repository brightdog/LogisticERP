...
End If
	...
	SqlCount = "SELECT count(*) FROM tblWarehouse Where 1=1 " & SqlWhere
	...
	SqlSelect = " SELECT TOP " & PageSize & " *  From tblWarehouse " & " where 1=1 " & SqlWhere & " and WarehouseID Not In(SELECT TOP " & (CurrentPage - 1) * PageSize & " WarehouseID From tblWarehouse where 1=1 " & SqlWhere & SqlOrder & ")"  & SqlOrder
