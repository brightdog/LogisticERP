...
End If
	...
	SqlCount = "SELECT count(*) FROM vwOutWarehouseReceipt_List Where 1=1 " & SqlWhere
	...
	SqlSelect = " SELECT TOP " & PageSize & " *  From vwOutWarehouseReceipt_List " & " where 1=1 " & SqlWhere & " and OutWarehouseReceiptID Not In(SELECT TOP " & (CurrentPage - 1) * PageSize & " OutWarehouseReceiptID From vwOutWarehouseReceipt_List where 1=1 " & SqlWhere & SqlOrder & ")"  & SqlOrder
