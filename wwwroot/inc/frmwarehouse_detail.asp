...
End If
	...
	If dicFieldValue.Item("WarehouseID") <> "" Then
		strSql = "Select * from tblWarehouse Where WarehouseID = " & dicFieldValue.Item("WarehouseID")
	Else
		strSql = "Select * from tblWarehouse Where 1 = 2"
	End If
	...
	If Rst.Eof Then
		...
		Rst.Open "Select Top 1 * From tblWarehouse Order By WarehouseID Desc", adoConn, 0, 1
	...
	Else
		...
		Rst.Open "Select Top 1 * From tblWarehouse Where WarehouseID = " & dicFieldValue.Item("WarehouseID"), adoConn, 0, 1
