...
If Not Rst.Eof Then
	...
	If Rst.Fields.Item("InventoryState").Value <> "已入库" Then
	Dim strFromWarehouseID
	strFromWarehouseID = Rst.Fields.Item("FromWarehouseID").Value

	
	adoConn.Execute "Insert Into tblInventory(OutWarehouseReceiptID,FromWarehouseID,ToWarehouseID,ExpressNO,InventoryState,CreateEmp)Values(" & strOutWarehouseReceiptID & "," & strFromWarehouseID & "," & strToWarehouseID & ",'" & strExpressNO & "','已入库','" & dic.CreateEmp & "')"
