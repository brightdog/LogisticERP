...
End If
	...
	SqlCount = "SELECT count(*) FROM tblCust Where 1=1 " & SqlWhere
	...
	SqlSelect = " SELECT TOP " & PageSize & " *  From tblCust " & " where 1=1 " & SqlWhere & " and CustID Not In(SELECT TOP " & (CurrentPage - 1) * PageSize & " CustID From tblCust where 1=1 " & SqlWhere & SqlOrder & ")"  & SqlOrder
