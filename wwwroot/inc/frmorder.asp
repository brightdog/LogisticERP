...
Dim CurrentPage, PageNum, AddtionalQueryString
...
End If
	...
	AddtionalQueryString = dic.AddtionalQueryString
	SqlWhere = MakeSqlWhere(dic.Fields,dic.Opers, dic.Values) & " " & AddtionalQueryString

	SqlCount = "SELECT count(*) FROM vwOrder_ListView Where 1=1 " & SqlWhere
	...
	SqlSelect = " SELECT TOP " & PageSize & " *  From vwOrder_ListView " & " where 1=1 " & SqlWhere & " and OrderID Not In(SELECT TOP " & (CurrentPage - 1) * PageSize & " OrderID From vwOrder_ListView where 1=1 " & SqlWhere & SqlOrder & ")"  & SqlOrder
